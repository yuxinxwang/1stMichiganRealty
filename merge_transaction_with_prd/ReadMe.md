This repository contains codes that to merge transaction data with public records data. The reader may want to consult ```flow_chart.html``` for a high-level view of the logic.
